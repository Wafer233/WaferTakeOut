...
import (
	...
	application2 "github.com/Wafer233/WaferTakeOut/Server/wafer-take-out-server/internal/addressbook/internal/application"
	"github.com/Wafer233/WaferTakeOut/Server/wafer-take-out-server/pkg/result"
	"github.com/gin-gonic/gin"
)

type AddressHandler struct {
	svc *application2.AddressService
}

func NewAddressHandler(svc *application2.AddressService) *AddressHandler {
	return &AddressHandler{svc: svc}
}

func (h *AddressHandler) Create(c *gin.Context) {

	dto := application2.AddressDTO{}
...
func (h *AddressHandler) UpdateDefault(c *gin.Context) {
	...
	var addrId application2.DefaultIdDTO

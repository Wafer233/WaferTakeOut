...
import (
	"github.com/Wafer233/WaferTakeOut/Server/wafer-take-out-server/employee-service/internal"
...
func Init() (*gin.Engine, error) {
	wire.Build(
		...
		infrastructure.NewDefaultAddressRepository,

...
const file_employee_proto_rawDesc = "" +
	"\n" +
	"\x0eemployee.proto\x12\vemployee.v1\"F\n" +
	...
	"\temployees\x18\x02 \x03(\v2\x15.employee.v1.EmployeeR\temployees\"\xc2\x02\n" +
	"\bEmployee\x12\x0e\n" +
	...
	"\x05curId\x18\x04 \x01(\x03R\x05curId2\x83\x04\n" +
	"\x0fEmployeeService\x12@\n" +
	"\x05Login\x12\x19.employee.v1.LoginRequest\x1a\x1a.employee.v1.LoginResponse\"\x00\x12A\n" +
	"\bListPage\x12\x18.employee.v1.PageRequest\x1a\x19.employee.v1.PageResponse\"\x00\x12;\n" +
	"\bFindById\x12\x16.employee.v1.IdRequest\x1a\x15.employee.v1.Employee\"\x00\x12N\n" +
	"\fUpdateStatus\x12 .employee.v1.UpdateStatusRequest\x1a\x1a.employee.v1.EmptyResponse\"\x00\x12G\n" +
	"\x06Update\x12\x1f.employee.v1.AddEmployeeRequest\x1a\x1a.employee.v1.EmptyResponse\"\x00\x12G\n" +
	"\x06Create\x12\x1f.employee.v1.AddEmployeeRequest\x1a\x1a.employee.v1.EmptyResponse\"\x00\x12L\n" +
	"\x0eUpdatePassword\x12\x1c.employee.v1.PasswordRequest\x1a\x1a.employee.v1.EmptyResponse\"\x00B_Z]github.com/Wafer233/WaferTakeOut/Server/wafer-take-out-server/services/employee-service/protob\x06proto3"
...
var file_employee_proto_goTypes = []any{
	(*LoginRequest)(nil),        // 0: employee.v1.LoginRequest
	(*LoginResponse)(nil),       // 1: employee.v1.LoginResponse
	(*PageRequest)(nil),         // 2: employee.v1.PageRequest
	(*PageResponse)(nil),        // 3: employee.v1.PageResponse
	(*Employee)(nil),            // 4: employee.v1.Employee
	(*IdRequest)(nil),           // 5: employee.v1.IdRequest
	(*EmptyResponse)(nil),       // 6: employee.v1.EmptyResponse
	(*UpdateStatusRequest)(nil), // 7: employee.v1.UpdateStatusRequest
	(*AddEmployeeRequest)(nil),  // 8: employee.v1.AddEmployeeRequest
	(*PasswordRequest)(nil),     // 9: employee.v1.PasswordRequest
}
var file_employee_proto_depIdxs = []int32{
	4, // 0: employee.v1.PageResponse.employees:type_name -> employee.v1.Employee
	0, // 1: employee.v1.EmployeeService.Login:input_type -> employee.v1.LoginRequest
	2, // 2: employee.v1.EmployeeService.ListPage:input_type -> employee.v1.PageRequest
	5, // 3: employee.v1.EmployeeService.FindById:input_type -> employee.v1.IdRequest
	7, // 4: employee.v1.EmployeeService.UpdateStatus:input_type -> employee.v1.UpdateStatusRequest
	8, // 5: employee.v1.EmployeeService.Update:input_type -> employee.v1.AddEmployeeRequest
	8, // 6: employee.v1.EmployeeService.Create:input_type -> employee.v1.AddEmployeeRequest
	9, // 7: employee.v1.EmployeeService.UpdatePassword:input_type -> employee.v1.PasswordRequest
	1, // 8: employee.v1.EmployeeService.Login:output_type -> employee.v1.LoginResponse
	3, // 9: employee.v1.EmployeeService.ListPage:output_type -> employee.v1.PageResponse
	4, // 10: employee.v1.EmployeeService.FindById:output_type -> employee.v1.Employee
	6, // 11: employee.v1.EmployeeService.UpdateStatus:output_type -> employee.v1.EmptyResponse
	6, // 12: employee.v1.EmployeeService.Update:output_type -> employee.v1.EmptyResponse
	6, // 13: employee.v1.EmployeeService.Create:output_type -> employee.v1.EmptyResponse
	6, // 14: employee.v1.EmployeeService.UpdatePassword:output_type -> employee.v1.EmptyResponse
